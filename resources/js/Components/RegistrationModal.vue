...
<template>
        <div class="fixed inset-0 flex items-center py-20 justify-center z-50 overflow-auto" style="background-color: rgba(0, 0, 0, 0.5);">
            <!-- Modal content -->
            <div class="bg-blue-100 p-15  max-w-7xl mx-auto rounded-lg shadow-lg z-50">
              <h2 class="text-white text-2xl p-4 bg-mmsu-color rounded-t-lg" style="border-bottom: 3px solid #ffcd00" src>
                Create Account
              </h2>
                ...
                <form class="p-8">
                  <div class="grid gap-6">
                      ...
                      <div class="space-y-2">
                          ...
                          <Button variant="danger" @click="closeModal" class=" justify-center gap-2 w-full 
