...
export const HomeIcon = defineComponent({
  ...
  <path d="M12 2L2 12H6V21H18V12H22L12 2ZM7.5 13.5V19.5H4.5V13.5H3V21H2V12H4.5L12 5.62L19.5 12H22V13.5H20.5V19.5H17.5V13.5H14.5V19.5H12V16.5H9V19.5H7.5Z" />
        </svg>
      );
    },
  })
  export const SubmissionIcon = defineComponent({
    setup() {
      return () => (
        <svg
          viewBox="0 0 24 24"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
            <path d="M12 5V15H9V5H4L12 1L20 5H15V15H12ZM4 19V17H20V19H4ZM13 12V9H11V12H8L12 16L16 12H13Z" />
        </svg>
      );
    },
  });
